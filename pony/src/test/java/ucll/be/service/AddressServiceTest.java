...
public class AddressServiceTest {
    ...
    @Test
    public void givenDefaultAddress_whenGettingAddressById_thenAddressWithThatIdReturned() {
        // Given
        Long id = 1L;
    ...
    public void givenAddressWithNumberOfAnimals_whenGettingAddressById_thenAddressWithThatIdReturned() {
        // Given
        Long id = 1L;
    ...
    @Test
    public void givenNumberOfAnimals_whenGettingAddressWithNumberOfAnimalsGreater_thenAddressesWithNumberOfAnimalsGreaterThanReturned() {
        // Given
